...
func (iq *ItemQuery) FirstID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (iq *ItemQuery) FirstIDX(ctx context.Context) uint {
...
func (iq *ItemQuery) OnlyID(ctx context.Context) (id uint, err error) {
	var ids []uint
...
func (iq *ItemQuery) OnlyIDX(ctx context.Context) uint {
...
func (iq *ItemQuery) IDs(ctx context.Context) (ids []uint, err error) {
...
func (iq *ItemQuery) IDsX(ctx context.Context) []uint {
	ids, err := iq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (iq *ItemQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(item.Table, item.Columns, sqlgraph.NewFieldSpec(item.FieldID, field.TypeUint))
	_spec.From = iq.sql
